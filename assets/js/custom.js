...
(function($){
	...
	$(document).ready(function() {
        ...
        $(document).on('click', function(e) {
          var container = $('.inner-navigation.show');
          if (!container.is(e.target) && container.has(e.target).length === 0) {
            $('body').removeClass('.inner-navigation.show');
          }
        });
         ...
         $(function () {
            ...
            $('.mobile-nav-blk-op.show').click(function() {
                $('.inner-navigation.show').removeClass('show');
            });

            $('.mobile-nav-target').click(function() {
              //close nav
                $('.mobile-nav-blk-op').addClass('show');
            });
           
            $('.mobile-nav-blk-op').click(function() {
              //close nav
                $('.inner-navigation.show').removeClass('show');
                $('.mobile-nav-blk-op').removeClass('show');
            });
